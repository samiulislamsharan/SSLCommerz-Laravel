...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function setRequiredInfo(array $info)
    {
        ...
        $this->data['product_category'] = $info['product_category']; // string (50)	Mandatory - Mention the product category. It is a open field. Example - clothing,shoes,watches,gift,healthcare, jewelry,top up,toys,baby care,pants,laptop,donation,etc
        ...
        $this->data['fail_url'] = $this->getFailedUrl(); // string (255)	Mandatory - It is the callback URL of your website where user will redirect after any failure occurred during payment (Length: 255)
